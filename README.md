...
A chess game with an AI opponent and user interface implemented in Python. The AI uses the Minimax algorithm with alpha-beta pruning to decide its moves.
